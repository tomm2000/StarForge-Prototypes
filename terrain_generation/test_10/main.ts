import { ArcRotateCamera, Engine, HemisphericLight, StandardMaterial, Vector3, MeshBuilder, Scene, Color4 } from "babylonjs"
...
function onUpload(payload: Event) {
  ...
  fr.onload = () => {
    ...
    item = new Planet(scene, undefined, new PlanetData(data))
  }
}
